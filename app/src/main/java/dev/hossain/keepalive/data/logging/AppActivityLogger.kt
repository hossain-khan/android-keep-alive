 ...
 */
class AppActivityLogger(private val context: Context) {
    companion object {
    ...
    // Create a DataStore instance for storing activity logs
     ...
     */
    val activityLogs: Flow<List<AppActivityLog>> = context.activityLogDataStore.data.map { preferences ->
